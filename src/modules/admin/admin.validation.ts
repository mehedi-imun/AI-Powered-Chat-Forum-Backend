...
export const updateSystemSettingsSchema = z.object({
	body: z.object({
		...
		maxThreadTitleLength: z.number().int().min(50).max(500).optional(),
		maxPostContentLength: z.number().int().min(100).max(50000).optional(),
		maxTagsPerThread: z.number().int().min(1).max(20).optional(),
