...
describe("E2E Tests - User Flow", () => {
  ...
  describe("Security & Authorization", () => {
    ...
    it("should reject requests with expired token", async () => {
      const expiredToken =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NzI5YTQ5YzRiNzJmZDg5ZjY2MjcyZTAiLCJlbWFpbCI6InRlc3RAZXhhbXBsZS5jb20iLCJyb2xlIjoiTWVtYmVyIiwiaWF0IjoxNzMwNzU1NzQwLCJleHAiOjE3MzA3NTU3NDF9.invalid";
